...
# # # # torch.cuda.current_device()  # Commented out for CPU-only environments  # Commented out for CPU-only environments  # Commented out for CPU-only environments  # Commented out for CPU-only environments
